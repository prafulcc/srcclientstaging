<script>
	...
	// Changed animated text to focus on the impact volunteers make
	const impacts = ['Medical Research', 'Future Treatments', 'Global Healthcare'];
	let index = 0;

	onMount(() => {
		const interval = setInterval(() => {
			index = (index + 1) % impacts.length;
		}, 3000);
...
<div class="relative overflow-hidden">
	<div
		...
		style="
			background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('https://unsplash.com/photos/DbCfSrTnflA/download?force=true&w=2400');
	...
	<div class="relative z-10 mx-auto max-w-7xl">
		<div class="pb-8 sm:pb-16 md:pb-20 lg:pb-28 xl:p-32">
			<main class="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 lg:mt-16 lg:px-8">
				<div class="sm:text-center lg:text-left">
					<h1 class="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">
						...
						<span class="block text-white">
							...
							<span class="inline-grid text-emerald-400">
								...
								{/key}
								<span class="pointer-events-none invisible col-start-1 row-start-1 opacity-0">
									{impacts[0]}
								</span>
							</span>
						</span>
					...
					<p
						...
						style="color: white"
					>
						Join our clinical trials and play a vital role in developing new, life-saving therapies.
						Your participation helps shape the future of medicine while you receive expert care.
					</p>
